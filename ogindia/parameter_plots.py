...
from ogindia.constants import GROUP_LABELS
...
def plot_imm_rates(p, year=2019, include_title=False, path=None):
    '''
    Create a plot of immigration rates from OG-India parameterization.
...
def plot_mort_rates(p, include_title=False, path=None):
    '''
    Create a plot of mortality rates from OG-India parameterization.
