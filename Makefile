...
.PHONY=package
package:
	@pbrelease OG-India ogindia 0.0.0 --local

.PHONY=pytest
pytest:
	@cd ogindia ; pytest -W ignore

OGINDIA_JSON_FILES := $(shell ls -l ./ogindia/*json | awk '{print $$9}')

.PHONY=cstest
cstest:
	-pycodestyle ogindia
	-pycodestyle --ignore=E501,E121 $(OGINDIA_JSON_FILES)
